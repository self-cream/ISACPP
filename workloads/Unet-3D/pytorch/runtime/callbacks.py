...
class EvaluationCallback(BaseCallback):
    ...
    def on_iter_end(self, current_epoch, max_epoch, iteration, iter_per_epoch):
        max_iterations = max_epoch * iter_per_epoch
        elapsed_iterations = (current_epoch - 1) * iter_per_epoch + iteration - 1
