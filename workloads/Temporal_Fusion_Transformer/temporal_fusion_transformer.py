...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for local_step, batch in enumerate(train_loader):
            ...
            epoch_data['ELAPSED_ITERATIONS'] = str(global_step)
            epoch_data['TOTAL_ITERATIONS'] = str(max_iterations)
    ...
    #example_input_list = [(512, 192, 1), (512, 1), (512, 1), (512, 192, 3), (512, 1), (512, 1), (512, 192, 1), (512, 192, 1)]
    ...
    onnx_tool.model_profile(onnx_model_path,saveshapesmodel='shapes.onnx')
    ...
    for node in onnx_model.graph.node:
        ...
        # Increment the GEMM count for MatMul operations
            relu_count += 1
    ...
    print(f"Total number of Flatten operations: {flatten_count}")
