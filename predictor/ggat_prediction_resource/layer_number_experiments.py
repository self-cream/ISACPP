...
model_1 = GGAT_with_1_block(in_dim=24, hidden_dim=512, out_dim=3, dropout=1, num_heads=3).to(device)
model_2 = GGAT_with_2_blocks(in_dim=24, hidden_dim=512, out_dim=3, dropout=1, num_heads=3).to(device)
model_3 = GGAT_with_3_blocks(in_dim=24, hidden_dim=512, out_dim=3, dropout=1, num_heads=3).to(device)
model_4 = GGAT_with_4_blocks(in_dim=24, hidden_dim=512, out_dim=3, dropout=1, num_heads=3).to(device)
model_5 = GGAT_with_5_blocks(in_dim=24, hidden_dim=512, out_dim=3, dropout=1, num_heads=3).to(device)
...
r2_function = R2Score(multioutput='raw_values').to(device)
pred_err_function = PredictionErr().to(device)

print('Loading the best epoch of our prediction with 1 E-GGAT block')
model_1.load_state_dict(torch.load('./layer_trained_models/1_E_GGAT/28.pkl'))
...
model_2.load_state_dict(torch.load('./layer_trained_models/2_E_GGAT/24.pkl'))
...
model_3.load_state_dict(torch.load('./layer_trained_models/3_E_GGAT/31.pkl'))
...
model_4.load_state_dict(torch.load('./layer_trained_models/4_E_GGAT/32.pkl'))
...
model_5.load_state_dict(torch.load('./layer_trained_models/5_E_GGAT/30.pkl'))
